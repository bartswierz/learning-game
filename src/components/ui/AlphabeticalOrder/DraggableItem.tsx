...
const DraggableItem = ({ text, id, className = "" }: DraggableItemProps) => {
  ...
  return (
    <div key={id} className={`bb p-4 touch-none ${className}`} ref={setNodeRef} {...attributes} {...listeners} style={style}>
      {text}
